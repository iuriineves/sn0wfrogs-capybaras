...
import iuriineves.neves_capybaras.entity.ai.CapybaraWalk;
import iuriineves.neves_capybaras.entity.ai.FollowTemptationFixed;
import iuriineves.neves_capybaras.entity.ai.Loaf;
import iuriineves.neves_capybaras.entity.ai.StayAroundBlocks;
...
public class CapybaraEntity extends AnimalEntity implements GeoEntity, SmartBrainOwner<CapybaraEntity> {
    ...
    private <E extends CapybaraEntity>PlayState walkAnimController(final AnimationState<E> event) {
