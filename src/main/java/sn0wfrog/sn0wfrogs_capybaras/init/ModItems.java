...
public interface ModItems {
    ...
    Item MANDARIN = createItem("mandarin", new Item(new Item.Settings().food(new FoodComponent.Builder().nutrition(4).saturationModifier(0.3f).statusEffect(new StatusEffectInstance(ModStatusEffects.SWEETENED, 100), 1).build())));
